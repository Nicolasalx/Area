...
class AuthGoogle {
  static Future<bool> login(String code) async {
    try {
      Uri uriBackGoogle = Uri.parse('${dotenv.env['FLUTTER_PUBLIC_BACKEND_URL']}/auth/google/callback/?code=$code&redirect_uri=${dotenv.env['GOOGLE_REDIRECT_URI']}');
      ...
      ..setNavigationDelegate(
        NavigationDelegate(
          ...
          onNavigationRequest: (NavigationRequest request) {
            var uri = Uri.parse(dotenv.env['GOOGLE_REDIRECT_URI']??"error");
